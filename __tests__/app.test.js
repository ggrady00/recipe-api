...
const {tagsData, ingredientsData, usersData, recipesData, commentsData, ratingsData, recipeTagsData, recipeIngredientsData} = require("../db/data/test-data/index")

beforeEach(() => {
    return seed({tagsData, ingredientsData, usersData, recipesData, commentsData, ratingsData, recipeTagsData, recipeIngredientsData})
})
afterAll(() => {
    return db.end()
})
